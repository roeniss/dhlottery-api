...
def write_py_file_tree_and_content(root_folder, output_file):
...
output_file = 'py_file_tree_with_content.txt'  # 결과를 저장할 파일 경로 지정

write_py_file_tree_and_content(root_folder, output_file)
